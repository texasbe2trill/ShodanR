...
# Convert Country to a factor for unique color assignment
shodan_count$Country <- factor(shodan_count$Country)

# Generate a unique color for each country
num_countries <- length(unique(shodan_count$Country))
palette_colors <- distinctColorPalette(num_countries) # Ensures unique colors
