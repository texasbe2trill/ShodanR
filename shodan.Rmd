...
if (length(most_common_country) > 1) {
  ...
  cat("According to the Shodan dataset,", country_text,
    ...
    "The mean number of ransomware infections per country is", 
...
## Ransomware Infections by Country and City

```{r, r map-plot, echo=FALSE, fig.width=10, fig.height=6, out.width="100%"}
...
## Interactive Ransomware Infections Map

```{r interactive-map-plot, echo=FALSE, fig.width=10, fig.height=6, out.width="100%"}
