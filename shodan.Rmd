...
repeat {
  ...
  Sys.sleep(1)  # Sleep for 1 second to avoid rate limitinginde
...
if (most_common_country == "United States") {
  cat("According to the Shodan dataset, the", most_common_country,
    ...
    round(mean(common_country_count), 2), "incident(s).", "\n",  # Average
    "The median number of ransomware infections per country is",
    median(common_country_count), "incident(s).", "\n", # Median
    "The standard deviation of ransomware infections per country is",
    round(sd(common_country_count), 2), "incident(s).", "\n") # Standard Deviation
} else {
  # All other countries
